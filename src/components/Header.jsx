...
function PagesDetail() {
  ...
  const { title, data, icon } = displayTotalItem();
    ...
    <div className="mr-2 hidden md:block lg:mr-8">
      <ul className="flex gap-x-1 lg:gap-x-4">
        ...
        <li className="transition-all hover:rounded-md hover:bg-slate-900/30">
          ...
          >
            <span className="block px-2 py-4 font-semibold">Characters</span>
          </NavLink>
        </li>
        <li className="transition-all hover:rounded-md hover:bg-slate-900/30">
          <NavLink
          ...
          >
            <span className="block px-2 py-4 font-semibold">Episodes</span>
          </NavLink>
        </li>
        <li className="transition-all hover:rounded-md hover:bg-slate-900/30">
          <NavLink
          ...
          >
            <span className="block px-2 py-4 font-semibold">Locations</span>
          </NavLink>
        </li>
      </ul>
    </div>
      ...
      >
        <span>
          <svg
            ...
            height="40"
            viewBox="0 0 50 50"
            className="fill-current text-slate-800 dark:text-slate-300"
          >
